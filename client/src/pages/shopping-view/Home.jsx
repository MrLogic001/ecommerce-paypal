...
const ShoppingHome = () => {
  ...
  const { shoppingProducts, productDetails } = useSelector((state) => state.shopProducts);
  ...
  console.log(shoppingProducts, "shoppingProducts", productDetails);  

  useEffect(() => {
    getAllFilteredProducts({ filterParams: {}, sortParams: "price-lowtohigh" });
  }, [dispatch]);
